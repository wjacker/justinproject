...
public class _testExp_Styles
{
    [Embed(_resolvedSource='C:/Program Files/Adobe/Adobe Flash Builder 4/sdks/4.1.0/frameworks/libs/framework.swc$Assets.swf', symbol='mx.skins.cursor.BusyCursor', source='C:/Program Files/Adobe/Adobe Flash Builder 4/sdks/4.1.0/frameworks/libs/framework.swc$Assets.swf', original='Assets.swf', _line='534', _pathsep='true', _file='C:/Program Files/Adobe/Adobe Flash Builder 4/sdks/4.1.0/frameworks/libs/framework.swc$defaults.css')]
    private static var _embed_css_Assets_swf_mx_skins_cursor_BusyCursor_899767333:Class;
    public static function init(fbs:IFlexModuleFactory):void
    {
        ...
        if (style.defaultFactory == null)
        {
            style.defaultFactory = function():void
            {
                this.textFieldClass = mx.core.UIFTETextField;
                this.textAlign = "center";
        ...
        if (style.defaultFactory == null)
        {
            style.defaultFactory = function():void
            {
                ...
                this.busyCursorBackground = _embed_css_Assets_swf_mx_skins_cursor_BusyCursor_899767333;
            };
        }
        ...
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.controls.Label");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
