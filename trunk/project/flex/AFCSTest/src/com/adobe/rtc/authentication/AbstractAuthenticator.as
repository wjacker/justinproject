package com.adobe.rtc.authentication
{
	...
	*/
	...
	{	
		...
		/**
		 * For applications that leverage AFCS's external authentication capabilities, <code 
		 ...
		 * For details about external authentication, refer to the <i>AFCS Developer Guide</i> and the server scripts
