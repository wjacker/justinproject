package com.adobe.rtc.sharedModel
{
	...
	/**
	 * SharedObject is used to store data in an unordered hash (key-value) across the AFCS services; elements can only be accessed using its key.
	 * <p>
	...
	public class SharedObject extends EventDispatcher implements ISessionSubscriber
	{
		...
		protected function onItemReceive(p_evt:CollectionNodeEvent):void
		{
			...
			evt = new SharedObjectEvent(eventType,newItemToAdd.itemID, newItemToAdd.body);
