package com.adobe.rtc.collaboration
{
	 ...
	 * <p>
	 * Files are organized logically in AFCS as <i>groups</i> in the FileManager, 
	...
	public class FilePublisher extends UIComponent implements ISessionSubscriber
	{
        ...
        * @default null
		 ...
		 * attributes were set by the manager that AFCS was previously unaware of, so update the
		 * model here.
		 */
