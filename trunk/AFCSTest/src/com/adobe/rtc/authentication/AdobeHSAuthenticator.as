package com.adobe.rtc.authentication
{
	...
	/**
	 * 
	 * AdobeHSAuthenticator is used to log users into a AFCS hosted room with the 
	 ...
	 * of a host of other benefits as described in the <i>AFCS Developer Guide</i>. See <b>Example 2</b> below. 
 	 * </ul> 
	 *
	 * <blockquote>
     * <b>Note</b>: It's possible to develop offline without a connection to the AFCS service. Simply 
	 ...
	 * detect the local server. For details, refer to the <i>AFCS Developer Guide</i> or the 
	 ...
	 * <i>AFCS Developer Guide</i> and the scripts in the SDK's "extras/scripts" directory. 
