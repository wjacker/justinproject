package com.adobe.rtc.messaging.manager
{
	...
	/**
	 * @private
	 * MessageManager is an implementation of the set of messaging primitives required for the foundations of a AFCS app. 
	 * 
	 * MessageManager is a singleton whose job is to manage the set of CollectionNode components which are instantiated throughout a AFCS
