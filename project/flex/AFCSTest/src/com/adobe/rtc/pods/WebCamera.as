...
//				_startStopBtn.selected = true ;
			 ...
			 * 
			 */			
			protected function onStreamDimensionChangeFromSubscriber(p_evt:StreamEvent):void
			{
				invalidateDisplayList();
			}
		 ...
		 */
			...
			protected function recreateSubscribers():void
			{
				...
				if (_sbsSubscriber && contains(_sbsSubscriber)) {
					_sbsSubscriber.removeEventListener(StreamEvent.DIMENSIONS_CHANGE, onStreamDimensionChangeFromSubscriber);
					_sbsSubscriber.removeEventListener(StreamEvent.STREAM_DELETE, onStreamDeleteFromSubscriber);
				...
				switch (_layoutSetting) {
					...
					case CameraModel.SIDE_BY_SIDE:
						...
						_sbsSubscriber.addEventListener(StreamEvent.DIMENSIONS_CHANGE, onStreamDimensionChangeFromSubscriber);
						_sbsSubscriber.addEventListener(StreamEvent.STREAM_DELETE, onStreamDeleteFromSubscriber);
			 ...
			 * @private
			 */
			protected function onStreamDeleteFromSubscriber(p_evt:StreamEvent):void
			{
				invalidateDisplayList();
			}
