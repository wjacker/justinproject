...
public class _testExp_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _testExp_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "testExp" : String(params[0]);
    ...
    override    public function info():Object
    {
        return {
            ...
            compiledResourceBundleNames: [ "components", "containers", "controls", "core", "effects", "layout", "skins", "styles", "textLayout" ],
            currentDomain: ApplicationDomain.currentDomain,
            layout: "absolute",
            mainClassName: "testExp",
            mixins: [ "_testExp_FlexInit", "_testExp_Styles" ],
