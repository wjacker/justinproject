package com.adobe.rtc.session.managers
{
	...
	/**
	 * @private
	 * SessionManagerBase is the base implementation of the set of tasks required of SessionManager, a foundation class of any AFCS app. 
	 * See the diagram at : <a href="http://treebeard.macromedia.com/display/Breeze/Components+Needed+for+Cocomo">Components needed for AFCS</a> 
	 ...
	 * 	<li> The set of custom RPC passthroughs required by other Manager classes in the AFCS framework. Hopefully very limited.</li> 
	 * </ul> <p>
	...
	public class SessionManagerBase extends EventDispatcher
	{
		...
		*/
		...
		/**
		* @private
		* Whether or not a connection is established and authenticated for this session. 
		*/
		session_internal var isSynchronized:Boolean = false;
		...
		/**
		 * @private
		 * A ConnectSession's internal method for logging into a AFCS session. 
