package com.adobe.rtc.authentication
{
	 ...
	 * which enables offline development of AFCS applications. With the exception of streaming 
	 * components (i.e. Audio and Webcam components), most AFCS components work with the Local Server.
	 ...
	 * Start the local server by opening the AFCS SDK Navigator, selecting the tools tab, and choosing Local
